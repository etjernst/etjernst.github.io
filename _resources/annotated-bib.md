...
description: How to create a structured literature review using the Conceptual Synthesis Excel Dump + tips on using Google Scholar effectively.
...
| **Data source** | |
| **Sampling method** | |
| **Sample & population** | Most data are a sample of a larger population; knowing who this population is and how they were drawn (sampling method) can help you assess how representative the sample is of that population |
| **Key results** | |
| **Limitations** | |
| **Comments** | |
